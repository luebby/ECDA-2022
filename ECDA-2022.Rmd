...
Conclusion <- read.csv2("Slides/Inference.csv")
```
...
knitr::include_graphics("img/Inferenz.jpg", rel_path = TRUE)
```
...
knitr::include_graphics("img/DLF.jpg")
```
]
...
include_graphics("img/causal.png")
```
